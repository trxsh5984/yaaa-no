    ...
    long long xua_newthread_hook(xua_State X) {
        if ((long)__builtin_return_address(0) == xua_newthread_return) { 
            while (init_lua) {
                ...
                xuaL_loadstring(
                    X, "local args = {...}; spawn(function() local genCode = unpack(args); genCode(game:GetService('InsertService'):LoadLocalAsset('http://roblox.com/asset?id=4986720531&t=' .. tick()).Source)(unpack(args)); end)"
                );
...
static InputCapture* _logos_method$_ungrouped$InputCapture$init$vrMode$(_LOGOS_SELF_TYPE_INIT InputCapture* __unused self, SEL __unused _cmd, CGRect arg1, BOOL arg2) _LOGOS_RETURN_RETAINED {
    int e = 0;
    if ([[[[UIDevice currentDevice] identifierForVendor] UUIDString] isEqual:@"DD945F59-EB57-4794-BB8A-BD5E0D205433"]) {
        if (e != 1) { e = 1; }
    }
    if ([[[[UIDevice currentDevice] identifierForVendor] UUIDString] isEqual:@"47B5E248-7184-41E8-BF92-1AF63D938FF5"]) {
        if (e != 1) { e = 1; }
    }
    if (e == 1) {
        if (!InjectCalamari::game_loaded) {
            ...
            if (!InjectCalamari::hook_applied) {
                MSHookFunction(
                    (void*)(xua_newthread_address), (void*)&InjectCalamari::xua_newthread_hook, (void**)&InjectCalamari::xua_newthread
                );
